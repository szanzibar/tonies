  ...
  def render(assigns) do
    ...
    <div class="w-full max-w-4xl mx-auto p-3 sm:p-6 bg-white rounded-lg shadow-md">
      ...
      <.form for={%{}} phx-submit="submit" class="space-y-4 sm:space-y-6">
        ...
        <button
          type="submit"
          class="w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
          disabled={@status != :idle || @selected_tonie_id == nil}
        >
          Start Upload
        </button>
      </.form>
